defmodule EntropyBitsTest do
  ...
  test "bits for integer total and risk" do
    ...
    assert round(entropy_bits(10, 100_000)) == 22

    assert round(entropy_bits(100, 1000)) == 22
    assert round(entropy_bits(100, 10000)) == 26
    assert round(entropy_bits(100, 100_000)) == 29

    assert round(entropy_bits(1000, 1000)) == 29
    assert round(entropy_bits(1000, 10000)) == 32
    assert round(entropy_bits(1000, 100_000)) == 36

    assert round(entropy_bits(10000, 1000)) == 36
    assert round(entropy_bits(10000, 10000)) == 39
    assert round(entropy_bits(10000, 100_000)) == 42

    assert round(entropy_bits(100_000, 1000)) == 42
    assert round(entropy_bits(100_000, 10000)) == 46
    assert round(entropy_bits(100_000, 100_000)) == 49
  end
  ...
  test "preshing 64-bit" do
    ...
    assert round(entropy_bits(607_401, 1.0e08)) == 64
    assert round(entropy_bits(192_077, 1.0e09)) == 64
